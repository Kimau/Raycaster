...
public:
	...
	bool isIntersect(Vec3 _start, Vec3 _end) const;			// Returns if line intersects plane
	Vec3 getIntersectPoint(Vec3 _start, Vec3 _dir) const;	// Get point of Intersection
